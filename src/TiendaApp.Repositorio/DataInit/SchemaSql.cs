...
INSERT INTO Usuarios (Nombre, Password)
SELECT 'admin', '100000.Y3GvwTgJ7VyVLULCChFqHw==.tsnhVRmcSR8c0nDXmKxx6YGo2JogB2C021/Cr8YWmy8='
WHERE NOT EXISTS (SELECT 1 FROM Usuarios WHERE Nombre = 'admin');

INSERT INTO Usuarios (Nombre, Password)
SELECT 'gerente', '100000.9IjldYgrPkdLJRDXyF0ihA==.n61Vb7SJxwwO0MCqK0NqODtm8yUggYOBn3bEzGXawlE='
WHERE NOT EXISTS (SELECT 1 FROM Usuarios WHERE Nombre = 'gerente');

INSERT INTO Usuarios (Nombre, Password)
SELECT 'supervisor', '100000.KmT9vWcKnfEVPecEzJxHrA==.h6UsJFlCy8YVm2pmDRVHyTqQ6JJxdS1fX3baQS5VE0U='
WHERE NOT EXISTS (SELECT 1 FROM Usuarios WHERE Nombre = 'supervisor');

INSERT INTO Usuarios (Nombre, Password)
SELECT 'encargado', '100000.0Ty0YpNszl7hLjKZfEN5Gw==.tsF7XcrrrN2V3slmytYH8HFcY/HzMhPgH9MgfHBMU2I='
